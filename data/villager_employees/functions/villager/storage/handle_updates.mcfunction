...
execute at @e[tag=employee_storage_finder] store success score $items_updated _employee_option run data modify storage villager_employees:temp comparison.a set from block ~ ~ ~ Items
